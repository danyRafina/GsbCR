...
public class Queries {
	private static String tblSQuerySelect[] = {
		"SELECT COLLABORATEUR.COL_MATRICULE ,COL_MDP from COLLABORATEUR inner join TRAVAILLER ON COLLABORATEUR.COL_MATRICULE = TRAVAILLER.COL_MATRICULE where COLLABORATEUR.COL_MATRICULE = ? AND COL_MDP = ? AND TRA_ROLE!='Visiteur'",
		...
		"SELECT * from COLLABORATEUR inner join TRAVAILLER on COLLABORATEUR.COL_MATRICULE = TRAVAILLER.COL_MATRICULE where TRA_ROLE = 'Visiteur'  AND  TRAVAILLER.REG_CODE IN (SELECT REGION.REG_CODE FROM REGION inner join TRAVAILLER ON TRAVAILLER.REG_CODE = REGION.REG_CODE where COL_MATRICULE = ? AND TRA_ROLE !='Visiteur') ",
